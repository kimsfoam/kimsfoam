...
export const MainDashboardSolution = ({
  quote,
  setQuote,
}: {
  quote: QuoteType;
...
const SolutionCard = ({
  ...
  return (
    <label className="group has-checked:bg-brand-blue/8 transition-ease relative hidden w-full cursor-pointer flex-col gap-y-0.5 rounded-2xl p-4 has-checked:flex">
