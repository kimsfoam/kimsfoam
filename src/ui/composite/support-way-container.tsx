...
const WayCard = ({ children }: { children: ReactNode }) => {
  return (
    <div className="transition-ease flex w-full cursor-default flex-col items-center justify-start rounded-2xl p-12">
      {children}
    </div>
  );
};
