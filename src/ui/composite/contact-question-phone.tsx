      ...
      <div className="flex w-full flex-col items-start justify-start gap-y-4">
        ...
        <label className="relative flex flex-row items-center justify-start gap-x-4 p-4">
          ...
          <input
            ...
            inputMode="tel"
            className="bg-background-black text-text-gray transition-ease text-description w-full cursor-pointer appearance-none rounded-sm px-4 py-2 font-semibold shadow-sm outline-none"
          />
